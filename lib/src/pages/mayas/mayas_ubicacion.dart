...
class MayasUbicacionPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Ubicación de los Mayas')),
        body: _cardList());
  }

  Widget _cardList() {
    return FutureBuilder(
      future: provider.loadData('data/mayas_info.json', 'ubicacion'),
      initialData: [],
