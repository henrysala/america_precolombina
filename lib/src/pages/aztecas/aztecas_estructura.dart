...
class AztecasEstructuraPage extends StatelessWidget {
  @override
...
//trallendo la informacion desde el provider
  Widget _cardList() {
    return FutureBuilder(
      future: provider.loadData('data/aztecas_info.json', 'estructura'),
      initialData: [],
